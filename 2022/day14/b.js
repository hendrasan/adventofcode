...
// checking if the sand has reached the starting point
...
// don't need to decrement 1 because we got out of the loop when the sand reached the starting point
let result = numberOfSands;
